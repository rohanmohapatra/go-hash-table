...
func (c *helloServiceClient) SayHello(ctx context.Context, in *GenericMessage, opts ...grpc.CallOption) (*GenericMessage, error) {
...
func (UnimplementedHelloServiceServer) SayHello(context.Context, *GenericMessage) (*GenericMessage, error) {
...
func _HelloService_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloServiceServer).SayHello(ctx, req.(*GenericMessage))
	}
